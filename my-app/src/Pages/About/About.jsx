  ...
  return (
    <><div>
      <div>
        ...
        <p className='banner-para'>Natural and organic wood products that will perfectly suit your interior</p>
      </div>
      ...
      <div className="about-us-top-wrapper">
        <div className="top-left-wrap">
          ...
          <p className='para-twnty'>Over the past two decades, we have undoubtedly hone our skills and developed a unique style that sets our work apart.</p>
        </div>
        <p className='para-twnty'>Natural and organic wood products that will perfectly suit your interior</p>
      </div>

      <div className="about-us-top-wrapper">
        <img className='about-img' src="https://assets.website-files.com/64383cfe24c2e2d67e5b297b/644bb9b82621d8479dfee425_image%202.webp" alt="" />
